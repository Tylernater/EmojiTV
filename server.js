...
wss.on("connection", ws => {
  ...
  ws.on("message", raw => {
    ...
    /*
      EMOJI HUNT — SKIP ITEM

      Both players must press
      SKIP ITEM before the
      target changes.
    */
    if (
      message.type ===
